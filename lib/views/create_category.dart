...
class Category extends StatefulWidget {
  ...
  Category({this.type, this.category_type, this.filteredSearchString});
  @override
...
class _CategoryState extends State<Category> {
  ...
  Widget build(BuildContext context) {
    categoryName = widget.filteredSearchString;
    return Scaffold(
      backgroundColor: backgroundColor,
      appBar: AppBar(
        title: Text(widget.type == 'create' ? 'Add Category' : 'Edit Category'),
        centerTitle: true,
        elevation: 0,
      ),
      body: Center(
                  ...
                  Expanded(
                    child: TextField(
                      controller: TextEditingController(
                          text: widget.filteredSearchString),
